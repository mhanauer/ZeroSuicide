...
Given the number of zero, I used a hurlde model to account for the inflated number of zero: https://cran.r-project.org/web/packages/pscl/vignettes/countreg.pdf
...
## Figure out how to do the harmonic mean and what it means then run again
#modelH_int_n_hm = hurdle(Suicides ~ Intervention, dist = "poisson", zero.dist = "binomial",  harmonic(Time, 2,12), data = ITSTest)  
