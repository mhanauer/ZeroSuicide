...
trend_station_long
```
Because there is minimal evidence of autocorrelation and to another way of analyzing the data, I tried a moving average with first differences.  The moving average can help with the 
